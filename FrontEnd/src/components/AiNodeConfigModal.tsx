          ...
          >
            ...
            <form onSubmit={submit}>
              ...
              <textarea
                ...
                className="w-full p-3 border border-gray-300 dark:border-gray-600 rounded-md dark:bg-gray-700 dark:text-white min-h-[100px] resize-y focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                required
              />
